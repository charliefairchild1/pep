...
async def lingora_translate() -> str:
    return _product_page(
        ...
        capabilities=[
            ...
            ("Narrative-scale translation", "Layer preservation across whole passages, not just single sentences. Narrative voice, honorifics, cultural anchors, and register stay consistent paragraph to paragraph — the thing every commercial MT resets between sentences. See the Story Translation workbench at <a href='/lingora#story-tab' style='color:#4fc3f7'>/lingora#story-tab</a>."),
        ],
        demo_html="""<div style="font-size:11px;color:var(--dim);margin-bottom:8px">Try a phrase with pragmatic content:</div>
<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px"><button onclick="trPick('piece')" style="padding:4px 10px;border-radius:12px;border:1px solid var(--border);background:var(--surface);color:var(--text);font-size:10px;cursor:pointer">"piece of cake"</button><button onclick="trPick('bless')" style="padding:4px 10px;border-radius:12px;border:1px solid var(--border);background:var(--surface);color:var(--text);font-size:10px;cursor:pointer">"bless your heart"</button><button onclick="trPick('leg')" style="padding:4px 10px;border-radius:12px;border:1px solid var(--border);background:var(--surface);color:var(--text);font-size:10px;cursor:pointer">"break a leg"</button><button onclick="trPick('right')" style="padding:4px 10px;border-radius:12px;border:1px solid var(--border);background:var(--surface);color:var(--text);font-size:10px;cursor:pointer">"yeah right"</button><button onclick="trPick('wonderful')" style="padding:4px 10px;border-radius:12px;border:1px solid var(--border);background:var(--surface);color:var(--text);font-size:10px;cursor:pointer">"that's just wonderful"</button></div>
<div id="tr-results" style="min-height:200px"><div style="text-align:center;color:var(--dim);padding:40px;font-size:11px">Pick a phrase.</div></div>""",
        demo_script="""const TR_MAP = {piece:"It's a piece of cake", bless:"Bless your heart", leg:"Break a leg", right:"Yeah right", wonderful:"That's just wonderful"};
async function trPick(k) {
  ...
  document.getElementById('tr-results').innerHTML = `<div style="background:var(--surface);border:1px solid var(--border);border-radius:6px;padding:14px">${layers}<div style="margin-top:12px;display:grid;grid-template-columns:1fr 1fr;gap:12px"><div style="background:#0e1420;border:1px solid var(--border);border-left:3px solid #a78bfa;border-radius:4px;padding:10px"><div style="font-size:10px;color:#a78bfa;font-weight:bold;margin-bottom:4px">STANDARD MT</div><div style="font-size:12px">${d.mt_output}</div></div><div style="background:#0e1420;border:1px solid var(--border);border-left:3px solid #4fc3f7;border-radius:4px;padding:10px"><div style="font-size:10px;color:#4fc3f7;font-weight:bold;margin-bottom:4px">LINGORA</div><div style="font-size:12px">${d.lingora_output}</div></div></div><div style="margin-top:10px;font-size:11px;color:var(--dim);line-height:1.7">${d.explanation}</div></div>`;
        ...
        use_cases=[
            ...
            ("Publisher translating fiction", "A short story's narrator establishes a character's register in paragraph 1 (maternal-stern), modulates to reported speech in paragraph 2, reflects in paragraph 3. Standard MT resets defaults every sentence — the narrative voice drifts and the character's arc flattens.", "Lingora's story-scale mode carries register, honorifics, and cultural anchors across paragraphs. An untranslatable term introduced in ¶1 stays consistent in ¶4. Pragmatic intent compounds instead of resetting."),
        ],
        competitors=[
